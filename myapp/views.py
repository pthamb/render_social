...
#         if user1_interested and user2_interested:
#             user1_interest_count += 1
#             user2_interest_count += 1
#             matching_fields.append(field)

#     if user1_interest_count == 0 or user2_interest_count == 0:
#         return 0, []

#     similarity = (len(matching_fields) / min(user1_interest_count, user2_interest_count)) * 100
#     return similarity, matching_fields
...
def calculate_similarity(user1, user2):
    ...
    for field in fields:
        ...
        # Count as a match if both users are interested in the field
        if user1_interested and user2_interested:
            valid_fields += 1
            matches += 1
            matching_fields.append(field)
